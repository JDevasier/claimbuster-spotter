...
flags.DEFINE_string('cs_raw_clef_train_loc', '{}/clef20/task5/train.tsv'.format(FLAGS.cs_data_dir), 'Location of raw CLEF .csv data')
flags.DEFINE_string('cs_raw_clef_test_loc', '{}/clef20/task5/test-gold.tsv'.format(FLAGS.cs_data_dir), 'Location of raw CLEF .csv data')
